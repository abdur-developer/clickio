            ...
            <form action="action/update_course.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-floating mb-4">
                            <input type="text" name="alt" class="form-control" id="alt" 
                                   value="<?= htmlspecialchars($row['alt']) ?>" required>
                            <label for="alt"><i class="fas fa-image me-1 text-muted"></i>Alt Text</label>
                            <div class="invalid-feedback">Please provide alt text</div>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <!-- joined -->
                        <div class="form-floating mb-4">
                            <input type="number" name="joined" class="form-control" id="joined" 
                                   value="<?= htmlspecialchars($row['joined']) ?>">
                            <label for="joined"><i class="fas fa-tag me-1 text-muted"></i>Enrolled Users</label>
                        </div>
                        <!-- url_hint -->
                        <div class="form-floating mb-4">
                            <input type="text" name="url_hint" class="form-control" id="url_hint" 
                                   value="<?= htmlspecialchars($row['url_hint']) ?>">
                            <label for="url_hint"><i class="fas fa-tag me-1 text-muted"></i>URL Hint</label>
                        </div>
                        <!-- duration -->
                        <div class="form-floating mb-4">
                            <input type="text" name="duration" class="form-control" id="duration" 
                                   value="<?= htmlspecialchars($row['duration']) ?>">
                            <label for="duration"><i class="fas fa-tag me-1 text-muted"></i>Duration (in hours)</label>
                        </div>
                        <!-- lessons -->
                        <div class="form-floating mb-4">
                            <input type="number" name="lessons" class="form-control" id="lessons" 
                                   value="<?= htmlspecialchars($row['lessons']) ?>">
                            <label for="lessons"><i class="fas fa-tag me-1 text-muted"></i>Lessons</label>
                        </div>
                        <!-- section -->
                        <div class="form-floating mb-4">
                            <input type="number" name="section" class="form-control" id="section" 
                                   value="<?= htmlspecialchars($row['section']) ?>">
                            <label for="section"><i class="fas fa-tag me-1 text-muted"></i>Section</label>
                        </div>
